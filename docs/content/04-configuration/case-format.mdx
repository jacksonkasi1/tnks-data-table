...
<TypeTable
  type={{
    urlFormat: {
      description: 'Format for URL parameters',
      type: "'snake_case' | 'camelCase' | 'PascalCase' | 'kebab-case'",
      required: false,
    },
    apiFormat: {
      description: 'Format for API requests',
      type: "'snake_case' | 'camelCase' | 'PascalCase' | 'kebab-case'",
      required: false,
    },
    keyMapper: {
      description: 'Custom key mapping function',
